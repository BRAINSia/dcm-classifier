...
def train(
    ...
    clf = RandomForestClassifier(n_estimators=50, max_depth=6, random_state=99)
...
if __name__ == "__main__":
    ...
    data_file = "/home/mbrzus/programming/dcm_train_data/V2-20240229/training/combined_all_training_data_Mar5_labeled.xlsx"
    x, y, cols = generate_training_data(data_file)
