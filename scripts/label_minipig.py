...
# df = pd.read_excel(
#     "/home/mbrzus/programming/dcm_train_data/raw_site_data/minipig/dicom_SIEREN_CLN2.xlsx"
# )
#
# columns_to_keep = [
#     "FileName",
...
# new_df.to_excel(
#     "/home/mbrzus/programming/dcm_train_data/labeling/minipig/combined_minipig_labeling_raw.xlsx"
# )
#
...
# new_df.to_excel(
#     "/home/mbrzus/programming/dcm_train_data/labeling/minipig/unique_series_descriptions_raw.xlsx"
# )
...
def update_labels_and_series_desc(series_desc_list: list, label: str):
    ...
    final_df = pd.read_excel(
        "/home/mbrzus/programming/dcm_train_data/labeling/minipig/combined_minipig_labeling_final.xlsx"
    )
    ...
    remaining_df = pd.read_excel(
        "/home/mbrzus/programming/dcm_train_data/labeling/minipig/combined_minipig_labeling_remaining.xlsx"
    )
    for series_desc in series_desc_list:
    ...
    series_desc_df = pd.read_excel(
        "/home/mbrzus/programming/dcm_train_data/labeling/minipig/unique_series_descriptions_remaining.xlsx"
    )
    for series_desc in series_desc_list:
...
# update_labels_and_series_desc(loc_series_descriptions, "bval_vol")
...
# update_labels_and_series_desc(flair_series_descriptions, "field_map")
...
for series_description_raw in series_descriptions_list:
    series_description = str(series_description_raw).lower()
    if (
        "t1" in series_description
        or "mprage" in series_description
        or "bravo" in series_description
    ):
